<?php
$titrePage = "Détails Joueurs Univers Himalia u160";
...
$urlogame = 'https://s160-fr.ogame.gameforge.com/api/playerData.xml?id='.$idj.''; 
...
<div class="text-center">
    ...
    <?php 
        echo "<h2>".$name." <font class='text-success'> [".$tag."]</h2><a  href='alliance.php?id=".$idalli."'><h3>".$alli."</a></font></h3>";
        ?>
</div>
